;RB --- The RB Operating System Kernel
;===================================================================

	BITS 16
	%DEFINE RBos_VER '1.0.0'	 ;OS version number
	%DEFINE RBos_API_VER 1	; API version for programs to check
	%DEFINE KEY_ESC		27
...
os_main:
	...
	mov es, ax			; segments ever again, as RBos and its programs
...
option_screen:
	...
	os_init_msg		db '*************************Welcome to RB Os OS****************************', 0
	os_version_msg		db 'Version ', RBos_VER, 0

	os_init_msg2		db '                         Hardware Information                               ', 0
	os_version_msg2		db 'Version ', RBos_VER, 0

	dialog_string_1		db 'Welcome to RB Operating System', 0
...
os_draw_background1:
	...
	mov cx, 01110001b		; Colour: white text on light blue
